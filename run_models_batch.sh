...
# python generate_results_chart.py --dir "C:\Users\camel\Desktop\Projects\MY_COURSE\dog breeds project\udacity AIPND-revision master intropyproject-classify-pet-images"

python generate_results_chart.py --dir "$(pwd)"
